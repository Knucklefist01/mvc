...
$router->addRoute("GET", "/dice", "\Mos\Controller\DiceGame");
$router->addRoute("POST", "/diceProcessor", "\Mos\Controller\DiceProcessor");

$router->addRoute("GET", "/yatzy", "\Mos\Controller\YatzyGame");
$router->addRoute("POST", "/yatzyProcessor", "\Mos\Controller\YatzyProcessor");
